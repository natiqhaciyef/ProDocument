...
import com.natiqhaciyef.uikit.databinding.CustomInputViewBinding
...
class CustomInputView(
    ...
    private fun defaultInit() {
        ...
        val typedArray = ctx.obtainStyledAttributes(
            attributeSet,
            R.styleable.com_natiqhaciyef_uikit_custom_CustomInputView
        )
        val customHint =
            typedArray.getString(R.styleable.com_natiqhaciyef_uikit_custom_CustomInputView_customHint)
        val customTitle =
            typedArray.getString(R.styleable.com_natiqhaciyef_uikit_custom_CustomInputView_customTitle)
        val customInputType =
            typedArray.getString(R.styleable.com_natiqhaciyef_uikit_custom_CustomInputView_customInputType)
