...
import com.natiqhaciyef.domain.usecase.payment.GetAllSavedPaymentMethodsUseCase
import com.natiqhaciyef.domain.usecase.payment.GetChequePdfUseCase
import com.natiqhaciyef.domain.usecase.payment.GetPickedPaymentDetailsUseCase
import com.natiqhaciyef.domain.usecase.payment.InsertNewPaymentMethodUseCase
import com.natiqhaciyef.domain.usecase.payment.StartPaymentUseCase
...
class PaymentViewModel @Inject constructor(
    ...
    private val insertNewPaymentMethodUseCase: InsertNewPaymentMethodUseCase,
    ...
    private fun insertNewPaymentMethod(mappedPaymentModel: MappedPaymentModel) {
        viewModelScope.launch {
            insertNewPaymentMethodUseCase.operate(mappedPaymentModel).collectLatest { result ->
                when (result.status) {
                    Status.SUCCESS -> {
                        if (result.data != null)
